...
It seems so.  Second, do the residuals look like they have approximately constant variance?  We will plot the residuals versus the fitted values and see whether there are any "fan" shapes:  
```{r}
...
The same plot above also gives us an answer to the third question: do the residuals look independent of each other?  We do not see any obvious patterns of dependence, in which adjacent residuals look more similar to each other than far-apart residuals.  
