...
Data files:  
- [http://jgscott.github.io/teaching/data/cps.csv](cps.csv): data from the [Current Population Survey](http://www.census.gov/cps/)], a major source of data about the American labor force.
...
And older works tend to earn more on average, than younger workers (the correlation is about 17%):  
```{r}
