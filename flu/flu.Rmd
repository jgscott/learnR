...
The `step` command should show _a lot_ of output on your screen as it searches for possible additions and deletions that improve the out-of-sample generalization error of the model.  If you want to suppress this output, add the flag `trace=0` to the `step` command.
